...
if (isset($_POST['username']) && isset($_POST['email']) && isset($_POST['password']) && isset($_POST['confirm'])) {
    ...
    if (empty($_POST['username'])) {
        ...
        $user = addslashes(htmlspecialchars(htmlentities(trim($_POST['username']))));
    ...
    if (empty($POST['password'])) {
        ...
        $pwd = addslashes(htmlspecialchars(htmlentities(trim($_POST['password']))));
    }
    if (empty($POST['confirm'])) {
        $errors["confirm_required"] = "true";
    } else {
        $confirm = addslashes(htmlspecialchars(htmlentities(trim($_POST['confirm']))));
    }
